...
=== Using the Red Hat CloudForms control engine to determine if an OpenStack instance is vulnerable for Meltdown/Spectre
...
+
. Click on the Refresh button until the
+
