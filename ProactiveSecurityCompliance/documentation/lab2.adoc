...
. Glance through this full report to see what rules passed/failed, severity of the rules, etc.  Notice that you can click on each rule for a deeper drill down.
+
...
=== Lab 2.8 Viewing the global status indicator in Satellite 6
...
=== Lab 2.9 Managing Users and Roles
