...
+
NOTE: A custom policy named *rhel7-custom* has already been uploaded for you. The *rhel7-custom* compliance policy simply checks to see if the AIDE package is installed.
