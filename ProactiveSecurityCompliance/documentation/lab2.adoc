...
. Now, let's power on our hosts. Log into CloudForms with *admin* as the Username and *r3dh4t1!* as the Password. On the left menus, navigate to *Compute → Infrastructure → Virtual Machines*.
+
