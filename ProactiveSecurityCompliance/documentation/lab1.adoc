...
+
NOTE: After clicking on refresh you will need to click on the *Provisioning* tab to view the Ansible output. For this lab, provisioning and scanning can take up to 10 minutes to complete.
+
