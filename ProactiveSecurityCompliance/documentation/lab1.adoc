...
+
. Press the refresh button periodically to refresh the Provisioning Ansible output. Note that after clicking on refresh you will need to click on the *Provisioning* tab to view the Ansible output.
+
