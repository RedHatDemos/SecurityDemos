...
=== Starting your VMs
. Before starting the lab steps, you will need to turn on your VMs. Log into CloudForms with *admin* as the Username and *r3dh4t1!* as the Password. On the left menus, navigate to *Compute -> Infrastructure -> Virtual Machines*.
+
...
+
image:images/lab0-poweronvms.png[500,500]
. Click *OK*.
