...
. Before starting the lab steps, you will need to turn on *some* (NOT all) of your VMs. Log into CloudForms (cfme-GUID.rhpds.opentlc.com) with *admin* as the Username and *r3dh4t1!* as the Password.
