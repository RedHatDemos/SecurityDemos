...
. Feel free to look at the other data collected during Smart State Analysis as well, such as Users, Groups, and Init Processes.
+
image:images/lab7.1-ssaresults-packages.png[1000,1000]

=== Creating and Viewing security reports for systems vulnerable to Meltdown and Spectre in a Hybrid Environment
...
+
image:images/lab7.1-cloudintelreports.png[500,500]
...
+
image:images/lab7.2-queue-reportresult.png[1000,1000]
