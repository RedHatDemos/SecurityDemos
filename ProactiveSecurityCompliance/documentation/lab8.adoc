...
. If not already there, log into to the workstation host as *lab-user* from your desktop system replacing *GUID* with your lab's *GUID*. Use the password *r3dh4t1!*
+
[source]
----
