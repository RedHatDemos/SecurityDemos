...
In order to import the CSV log into LibreOffice you need to transfer the CSV
file from the _audit.example.com_ system to the workstation system using `scp`
and then open the CSV file using LibreOffice:
