...
. Let's run the playbook locally in check mode to see how it would change the machine to put it into compliance. Make sure you run this on the *openscap.example.com* host:
+
