...
+
image:images/idm-whoadd2.png[500,500]

. Next, select *my_user_group* from the list of *Available User Groups* and add it to the *Prospective User Groupss* by pressing the > button. Press *Add*.
+
