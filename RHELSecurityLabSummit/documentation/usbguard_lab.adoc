...
All steps in the _Configuration_ section have been already performed in the Summit lab environment and it is mentioned from an informative purpose. You can skip it and start directly with the _Demonstration_ section of this lab.
