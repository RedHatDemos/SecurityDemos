= Lab 6: Auditing on Red Hat Enterprise Linux 8.0
...
You will need to enter the password "r3dh4t1!" to get in to _audit.example.com_.
...
Again, you will need to enter the password above to get in.
