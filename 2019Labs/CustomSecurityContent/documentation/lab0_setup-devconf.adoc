...
. This lab was primarily created to work on Red Hat^(R)^ Enterprise Linux^(R)^ machines, but it is totally compatible with Fedora. So whenever you see `rhel8` or `rhel7` throughout the lab you switch to `fedora`. For example:
...
----
+
nano rhel8/profiles/ospp.profile
