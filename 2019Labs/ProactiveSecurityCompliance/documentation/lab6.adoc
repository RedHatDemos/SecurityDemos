...
* Log in with the credentials `admin` and a password `r3dh4t1!`

* From the left menu, select "Job Templates" and locate the job template called LAMP / WordPress Deploy"
