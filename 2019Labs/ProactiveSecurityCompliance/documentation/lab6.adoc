...
=== Lab 6.3 (Left off : need to clean up documentation starting here)
This lab exercise is unrelated to the previous exploit. The
previous lab exercises were there to verify that the database was insecure and that one method of exploiting it was to change a login user for MySQL,
