...
>>>>>>> 099004161aad8475ce2ecc2d35b2fed86c98a51e
...
<<<<<<< HEAD
A number of tools have been installed and pre-configured to support the DevSecOps pipeline. Most of these tools are running containerized within the Red Hat OpenShift cluster. The following sections below describe the tools we will be using in this lab exercise.
=======
