...
A number of tools have been installed and configured to support the devsecops pipeline. Most of these tools are running containerized within the OpenShift cluster.  Here is the pipeline we will be stepping through during our lab:
