...
. Near the bottom of the *Lab GUID Assignment page* You will need to start your session VM's. Follow the instructions on the page, by clicking the *here* button, then in the Top Right corner, click the "All VMs: *Start*".  This takes about 12-15 minutes, so grab a cup of coffee or continue to read ahead, while this is starting up.
