...
== Lab Environment:
Your entire lab environment is hosted online and includes: Red Hat Virtualization, Red Hat Openstack Platform, Red Hat Openshift Container Platform, Red Hat Satellite, Red Hat Ansible Automation, Red Hat Insights, Red Hat CloudForms, and a workstation system which will have a public IP you can SSH into. You can get to all the listed Red Hat products and all your VMs from the workstation system.
...
* link:lab2.adoc[Lab 1: Security Vulnerability and Compliance Scanning and Auditing using Red Hat Ansible Automation and OpenSCAP in Red Hat Satellite]
* link:lab4.adoc[Lab 2: Host System Hardening and Security Compliance Remediations]
* link:lab5.adoc[Lab 3: Security Hardening a Web Application Application with Exploit]
* link:lab6.adoc[Lab 4: Automated Patching of Host Systems]
* link:lab3.adoc[Lab 5: Enforcing compliance with security policies using Red Hat CloudForms and Red Hat Ansible Automation]
* link:lab8.adoc[Lab 6: Proactive Security and Automated Risk Management with Red Hat Insights]
