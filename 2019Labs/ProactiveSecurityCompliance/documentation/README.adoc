...
* link:lab4.adoc[Lab 4: Additional Automated Security Hardening on Host Systems]
* link:lab5.adoc[Lab 5: Proactive Security and Automated Risk Management on Host Systems at Scale with Predictive Analytics]
