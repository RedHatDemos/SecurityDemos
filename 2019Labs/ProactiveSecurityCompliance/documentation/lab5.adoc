== (THIS LAB EXERCISE DOCUMENTATION STILL NEEDS TO BE UPDATED!!) Lab 5: Automated OpenSCAP security scans and remediations at the push of a button & viewing SCAP compliance reports
