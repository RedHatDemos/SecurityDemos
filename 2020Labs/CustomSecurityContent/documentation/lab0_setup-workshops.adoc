...
. Select the proper *Lab Code* from the drop-down list. Find the `SECURITYMA3 - Creating customized security policy content to automate security compliance` lab.
